  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://www.facebook.com/AlmalakTaxi-101398854854477')} style={styles.listItem}>
          <MaterialCommunityIcons name="facebook" size={25} color={Colors.ICON_COLOR} style={styles.leftIcon} />
          <Text style={styles.listItemText}>AlmalakTaxi Page</Text>
          <Feather name="chevron-right" size={15} color={Colors.TEXT_PRIMARY} style={styles.rightIcon} />
        </TouchableOpacity>

        <TouchableOpacity onPress={() => Linking.openURL('http://almalaktaxi.com')} style={styles.listItem}>
