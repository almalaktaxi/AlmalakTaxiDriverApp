  ...
  render() {
    ...
    return (
      <View style={styles.container}>
          ...
          <ImageBackground source={require('../assets/signup-bg.jpeg')} style={{ flex: 4, justifyContent: 'center', alignItems: 'center', resizeMode: 'contain', height: SCREEN_HEIGHT-200, width: SCREEN_WIDTH, marginBottom: 120, paddingTop: 50 }}>
